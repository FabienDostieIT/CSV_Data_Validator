...
interface CodeEditorProps {
  ...
  className?: string;
  readOnly?: boolean;
  errorDecorations?: EditorErrorDecoration[];
...
export default function CodeEditor({
  ...
  useEffect(() => {
    ...
    if (model) {
      ...
      const highlightDecorations = allDecorations.filter(
        (d) => d.options.className === "editor-highlight-line",
      );
