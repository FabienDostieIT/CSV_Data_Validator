...
- Name: CSV Data Validator E2E >> should load the home page and display the app title
- Location: /home/lefab/Documents/JSON_Schema_Validator/tests/e2e/e2e.spec.ts:4:3
...
Call log:
  - navigating to "http://localhost:3000/", waiting until "load"
    ...
    at /home/lefab/Documents/JSON_Schema_Validator/tests/e2e/e2e.spec.ts:5:16
```
