...
- Name: CSV Data Validator E2E >> should have the validate button disabled when no CSV is uploaded
- Location: /home/lefab/Documents/JSON_Schema_Validator/tests/e2e/e2e.spec.ts:19:3
...
Call log:
  - navigating to "http://localhost:3000/", waiting until "load"
    ...
    at /home/lefab/Documents/JSON_Schema_Validator/tests/e2e/e2e.spec.ts:20:16
```
