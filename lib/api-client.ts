...
export async function getSchemasList(): Promise<SchemaObject[]> {
  // In development, use the new dynamic list endpoint
  // In production, use the static index generated by the build script
  const url =
    process.env.NODE_ENV === "production"
      ? `${getApiBase()}/schemas/index.json`
      : "/api/list-schemas"; // Changed dev URL
